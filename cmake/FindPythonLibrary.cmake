...
if(PYTHONINTERP_FOUND)
  ...
  if(python_config)
    ...
    set(PYTHON_SITE_PACKAGES_INSTALL_DIR
      ${_TMP_PYTHON_SITE_PACKAGES_DIR} CACHE PATH
      "The directory where python modules will be installed to.")
    ...
    find_library(PYTHON_LIBRARY NAMES ${PYTHON_LIBRARY_NAMES}
      PATHS ${PYTHON_PREFIX}/lib ${PYTHON_PREFIX}/libs NO_DEFAULT_PATH)
  ...
  if(APPLE)
    ...
    if(Python_FRAMEWORKS)
      ...
      if(NOT PYTHON_LIBRARY)
        set (PYTHON_LIBRARY "-framework Python" CACHE FILEPATH
